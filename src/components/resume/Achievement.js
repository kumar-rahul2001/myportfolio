    ...
    >
      <div className="flex-1">
        ...
        <div className="mt-14 w-full h-[1000px] border-l-[6px] border-l-black border-opacity-30 flex flex-col gap-10">
          <ResumeCard
            title="Cleared BEU Exam"
            subTitle="Entrance Exam for Engineering colleges in Bihar (2020)"
            // result="153rd"
          ...
          <ResumeCard
            ...
            subTitle="7th Std Scholarship Exam conducted by Government of Bihar (2015)"
            result="206/300"
      ...
      <div className="flex-1">
        ...
        <div className="mt-14 w-full h-[1000px] border-l-[6px] border-l-black border-opacity-30 flex flex-col gap-10">
          {/* <ResumeCard
            title="General Knowledge Competency Analytical Test (ECAT)"
          ...
          <ResumeCard
            ...
            subTitle="Btech 5th Semester"
            // result="230/300"
            des="Got Certificate of Participation in Cisco Ideathon"
          />
        </div>
      </div>
    </motion.div>
